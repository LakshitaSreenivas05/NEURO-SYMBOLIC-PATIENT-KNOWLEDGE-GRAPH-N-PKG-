...
| Issue | Solution |
|-------|----------|
| No audio captured | Check microphone permissions and input device |
| Neo4j connection fails | Verify URI and credentials in `.env` |
| No entities extracted | Ensure medical spaCy model is installed |
| LLM errors | Check API keys and model availability |

## Future Enhancements

- [ ] Streamlit web UI for easier interaction
